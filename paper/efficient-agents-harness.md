...
![CPU与操作系统类比](./images/harness-01.jpg)
...
![模型是CPU，上下文是RAM，Harness是操作系统](./images/harness-02.jpg)
...
![四层系统架构](./images/harness-01-new.jpg)
...
![Agent Harness的详细视图](./images/harness-03.jpg)
